...
const QrGenerator = ({ prop }) => {
  ...
  useEffect(() => {
    if (data !== null && data !== "") {
      ...
      setTimeout(() => {
        setQrImageUrl(canvasElement.querySelector('canvas').toDataURL("image/png"));
      }, 1);
 ...
 <div ref={canvasRef} style={{display:'none'}}></div>
      {data && qrImageUrl && (
        ...
        <img src={qrImageUrl} alt="QR Code" className="opacity-1"/></div>
      ...
      <div className="button-home-container">
        <Button
          ...
          style={{  color: 'white', fontSize:'.7rem', padding:'3px 6px' }}

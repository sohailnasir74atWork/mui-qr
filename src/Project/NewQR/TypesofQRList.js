...
export const sideBar = [
  { icon: <ControlPointIcon />, heading: "New QR" },
  { heading: "Bulk QR Generator", icon: <BurstModeIcon /> },
  { heading: "Templates", icon: <DesignServicesIcon /> },
  { heading: "My QR Codes", icon: <QrCodeIcon /> },
];
